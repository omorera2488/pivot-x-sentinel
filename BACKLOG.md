...
- **Subtareas/experimentos:**
  ...
  - `BOT-047` `IN PROGRESS / RESEARCH` — D1 Alignment (feature padre, ver "Convención para features experimentales" más abajo):
    ...
    - `BOT-047.3` `BLOCKED` — D1 Alignment Out-of-Sample Validation (espera revisión humana del freeze `PROVISIONAL`).
...
- **Subtareas:**
  ...
  - `BOT-047.3` `BLOCKED` — OOS Validation (espera revisión humana explícita del freeze `PROVISIONAL`, no se desbloquea automáticamente).
...
- **Siguiente paso planificado dentro de BOT-047 (bloqueado, ver `BOT-047.3`):** revisión humana explícita del resultado `PROVISIONAL` — `BOT-047.3` no se desbloquea automáticamente.
