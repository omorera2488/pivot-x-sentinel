...
- **Subtareas:**
  ...
  - `BOT-047.2` `BLOCKED` — Definition Freeze (espera revisión humana explícita de BOT-047.1 antes de arrancar).
...
- **Siguiente paso planificado dentro de BOT-047 (bloqueado, ver `BOT-047.2`):** revisión humana explícita de estos candidatos (sección J del reporte) antes de congelar cualquier definición de Alignment.
...
- **Motivo del bloqueo:** `BOT-047.1` ya está `DONE` (ver reporte y candidatos, sección J de `reports/BOT-047.1-D1-ALIGNMENT-FEATURE-DISCOVERY.md`) — `BOT-047.2` permanece bloqueada hasta que esos hallazgos reciban revisión humana explícita (no se avanza automáticamente de Discovery a Definition Freeze).
