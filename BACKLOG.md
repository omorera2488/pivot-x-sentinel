...
- **Siguiente paso planificado dentro de BOT-049 (no ejecutado, ver `BOT-049.2`):** resolver la redundancia `risk_atr`↔`origin_dist_atr` (Structure) y congelar formalmente escala/fricción como definición de Economics — o documentar por qué no puede congelarse todavía.
